...
function FormExample() {
    ...
    const togglePass = () => {
        setToggle(!toggle);  // Toggles the 'toggle' state between true and false
    };
                ...
                <Row className="mb-3">
                    <Form.Group className='form-input pd-30-0' as={Col} md="6">
                        <Form.Group className='form-input' as={Col} md="12">
                            <i className="fa-solid fa-signature item-icon-input-form"></i>
                            <Form.Control
                                type='text'
                                name='fullName'
                    ...
                    <Form.Group className='form-input pd-30-0' as={Col} md="6">
                        <Form.Group className='form-input' as={Col} md="12">
                            <i className="fa-solid fa-lock item-icon-input-form"></i>
                            <Form.Control
                            ...
                            <i className={`fa-regular ${toggle ? 'fa-eye' : 'fa-eye-slash'} check-password eye-open`} onClick={togglePass}></i>
                        </Form.Group>
                        <div className='err-text'><span className='err-span'></span></div>
                    </Form.Group>
                    <Form.Group className='form-input pd-30-0' as={Col} md="6">
                        <Form.Group className='form-input' as={Col} md="12">
                            ...
                            <Form.Control
                                ...
                                required
                            />
                            <Form.Label className='lable-form' >Xác nhận mật khẩu</Form.Label>
                            <i className={`fa-regular ${toggle ? 'fa-eye' : 'fa-eye-slash'} check-password eye-open`} onClick={togglePass}></i>
                        </Form.Group>
                        <div className='err-text'><span className='err-span'></span></div>
                    </Form.Group>
